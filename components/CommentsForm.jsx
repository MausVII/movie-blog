...
export const CommentsForm = ({slug}) => {
    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            <h3 className='text-xl mb-8 font-semibolf border-b pb-4'>Leave a Comment</h3>
            ...
            <div className='grid grid-cols-1 gap-4 mb-4'>
                <div>
                    ...
                    className='ml-2 text-gray-500 cursor-pointer select-none'
                    >Save my e-mail and name for future comments.</label>
                </div>
            </div>
            {error && <p className='text-xs text-red-500'>All fields are required</p>}
            <div className='mt-8'>
                <button type="button" onClick={handleCommentSubmission}
                className='transition duration-500 ease hover:bg-indigo-900 inline-block bg-highlight text-lg rounded-full text-white px-8 py-3 cursor-pointer'
                >Post Comment</button>
            </div>
